---
name: linkedin-post
description: Write LinkedIn posts with a spicy, constructive tone about AI/tech — rage bait meets real insight
argument-hint: "<topic>"
---
...
- **Openly trash-talk AI hype and over-reliance** in tech generally — "we threw AI at it and it was terrible"
- **Always pivot to a constructive takeaway** — what actually works, what you learned, what people should do instead
- **Professional tone** — no personal attacks, no naming/shaming, no vulgarity
...
2. **Context/story** (what happened, what you observed in the industry)
